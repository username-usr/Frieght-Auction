          ...
          >
            ...
            <label className="mt-4 block">
              ...
              <textarea
                ...
                rows={3}
                className="mt-1 w-full rounded-md border border-slate-300 bg-slate-50 px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:bg-white disabled:cursor-not-allowed disabled:opacity-60"
              />
            </label>
